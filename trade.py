...
def main():
    ...
    end_time = datetime.datetime(year=dt_year, month=dt_month, day=dt_day, hour=9, minute=40, second=00).isoformat(timespec='seconds')

    print ( "YEAR: {} MONTH: {} DAY: {} HOURS: {} MINUTES: {} SECONDS: {}".format(dt_year, dt_month, dt_day, dt_hour, dt_min, dt_sec) )
    ...
    uber_price_info = rx.get_barset(symbols='UBER', timeframe='1Min', start=start_time, end=end_time)
